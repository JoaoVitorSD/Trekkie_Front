...
import ListCategorias from '../categoria/data_list_categorias'
import { useState } from 'react'

export default function FormCadastro({ closeModal }: any) {
    ...
    return (
        ...
        <div className={FormStyle['form-container']}>
                <button className={FormStyle['close-modal-button']} onClick={() => closeModal()} type="button">X</button>
